...
public class APICodeReadTest {
	...
	public APICodeReadTest(int input, double[][] expectedResult) {
		this.input = input;
		this.expected = expectedResult;
	}

	@Test
	public void testCodeReadAPI() throws UnsupportedAudioFileException, IOException {
		...
		double[][] actualData = dataSetManager.readCode(input);
